...
namespace org.iringtools.sdk.sql.test
{
    ...
    public class SQLDataLayerTest 
    {
        ...
        private org.iringtools.sdk.MSAccess.MSAccessDataLayer _MSdataLayer;
        ...
        public SQLDataLayerTest()
        {
            ...
            _settings["XmlPath"] = @"..\MSAccessTest.NUnit\12345_000\";
        ...
        [Test]
        public void A_Interface_MSAccessData()
        {
            _MSdataLayer = new MSAccess.MSAccessDataLayer();
        }
